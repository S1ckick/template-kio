...
% newcommand{\biblinespread}{1.1}            % межстрочный интервал внутри записи
% newcommand{\bibitemsep}{0pt}               % вертикальный отступ между записями
...
\begin{document}
    ...
    Видеоролик на YouTube~--- \cite{IEEEmtaOnlineVideo}.
