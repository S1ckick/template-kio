...
\begin{document}
    ...
    Этот раздел демонстрирует все типы источников, перечисленные в
    приложенном файле <<Для цитирования.docx>>. Подзаголовки повторяют
    структуру этого документа. Для каждого типа приведён один-два
    примера: их можно использовать как образец оформления и удалить из
    итоговой статьи.
    ...
    \begin{enumerate}
        ...
        \begin{itemize}[nosep]
            ...
            \item Глава книги с указанием издания, главы, раздела и страниц~--- \cite{OguraChapter}.
            \item Книга нескольких авторов с многими редакторами~--- \cite{MultiAuthorMultiEditor}.
            \item Глава с многими авторами, редактором и изданием~--- \cite{PontryaginMaxPrinciple}.
            \item Глава, написанная редактором тома~--- \cite{SanchezEditorAuthored}.
            \item Глава с переводчиком~--- \cite{SeriesTranslatorChapter}.
        \end{itemize}

        \item \textbf{Статьи}
        \begin{itemize}[nosep]
            \item Статья на русском с английским переводом~--- \cite{Matveenko}.
            \item Статья в журнале на другом языке (с пометкой <<(in Language)>>)~--- \cite{WignerGerman}.
            \item Статья в журнале с идентификатором (Art.~no.)~--- \cite{Fardel}.
        \end{itemize}

        \item \textbf{Блог}~---\cite{Owens}
        ...
        \item \textbf{Набор данных (датасет)}
        \begin{itemize}[nosep]
            \item Датасет на английском языке~--- \cite{HHSDataset}.
            \item Датасет на русском языке~--- \cite{vinitiDB}. 
        \end{itemize}
        ...
        \begin{itemize}[nosep]
            ...
            \item Электронный патент~--- \cite{WilliamsPatentOnline}.
        \end{itemize}
        ...
        \item \textbf{Магистерская ВКР}~--- \cite{KawasakiThesis}.

        \item \textbf{Кандидатская/PhD-диссертация}~--- \cite{WilliamsPhD}.

        \item \textbf{Документ правительства}~--- \cite{USHouseGov}.
        ...
        \item \textbf{Социальные сети}~--- \cite{CostanzoX}.
    \end{enumerate}
