...
\begin{document}
    ...
    This section illustrates every source type listed in the
    accompanying ``Для цитирования.docx'' file. Each numbered item is a
    category from that document; one or two examples per type are
    provided. Use them as templates and remove from the final
    submission.
    ...
    \begin{enumerate}
        ...
        \begin{itemize}[nosep]
            ...
            \item Book chapter with edition, chapter, section and page range~--- \cite{OguraChapter}.
            \item Multi-author book with several editors~--- \cite{MultiAuthorMultiEditor}.
            \item Chapter with several authors, editor and edition~--- \cite{PontryaginMaxPrinciple}.
            \item Chapter written by the volume editor~--- \cite{SanchezEditorAuthored}.
            \item Chapter with a translator~--- \cite{SeriesTranslatorChapter}.
        \end{itemize}

        \item \textbf{Articles}
        \begin{itemize}[nosep]
            \item Russian-language article with an English translation~--- \cite{Matveenko}.
            \item Periodical in a non-English language (with the ``(in Language)'' marker)~--- \cite{WignerGerman}.
            \item Periodical with article ID (Art.~no.)~--- \cite{Fardel}.
        \end{itemize}

        \item \textbf{Blog}~---\cite{Owens}
        ...
        \item \textbf{Online dataset}
        \begin{itemize}[nosep]
            \item English-language dataset~--- \cite{HHSDataset}.
            \item Russian-language dataset~--- \cite{vinitiDB}.
        \end{itemize}
        ...
        \begin{itemize}[nosep]
            ...
            \item Online patent~--- \cite{WilliamsPatentOnline}.
        \end{itemize}
        ...
        \item \textbf{Master's thesis}~--- \cite{KawasakiThesis}.

        \item \textbf{Ph.D. dissertation}~--- \cite{WilliamsPhD}.

        \item \textbf{Government document}~--- \cite{USHouseGov}.
        ...
        \item \textbf{Social media}~--- \cite{CostanzoX}.
    \end{enumerate}
